...
namespace CalculateParse
{
    public class CalculateParse
    {
        ...
        public static bool ParseCalculate(string input, out double result, out string? error)
        {
            ...
            if (int.TryParse(left, out num1) == false ||
                int.TryParse(right, out num2) == false)
            {
